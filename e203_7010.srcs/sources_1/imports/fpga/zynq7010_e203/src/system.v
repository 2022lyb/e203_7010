...
(
 ...
 // output wire qspi0_sck,
  ...
  //gpioA
  inout wire  rx_p19,//GPIOA00~GPIOA31

  //gpioB
  inout wire  tx_n18,//GPIOB00~GPIOB31
...
*/
  ...
  ip_mmcm ip_mmcm_i
       (.clk_in1_0(CLK100MHZ),
        .clk_out1_0(clk_16M),
        .clk_out2_0(CLK32768KHZ),
        .locked_0(mmcm_locked),
        .reset_0(ck_rst));

  assign ck_rst = fpga_rst & mcu_rst;

  reset_sys ip_reset_sys0
  (
    .slowest_sync_clk_0(clk_16M),
    .ext_reset_in_0(ck_rst), // Active-low
    .aux_reset_in_0(1'b1),
    .mb_debug_sys_rst_0(1'b0),
    .dcm_locked_0(mmcm_locked),
    .mb_reset_0(),
    .bus_struct_reset_0(),
    .peripheral_reset_0(reset_periph),
